...
class _SomViewState extends State<SomView> {
  ...
  void _onRotaCompletaChanged(bool value) async {
    await _audioService.setSomRotaCompleta(value);
    setState(() {});
  }
        ...
        children: [
          ...
          Card(
            ...
            shape: RoundedRectangleBorder(
              ...
              side: BorderSide(
                color: geralAtivo ? const Color(0xFF00B0FF).withValues(alpha: 0.5) : Colors.white12,
              ),
            ),
            child: SwitchListTile(
              ...
              subtitle: Text(
                ...
                style: TextStyle(
                  color: geralAtivo ? const Color(0xFF00B0FF) : Colors.white54,
                  fontSize: 13,
                ),
              ),
              value: geralAtivo,
          ...
          Card(
            ...
            child: Column(
              children: [
                _buildAudioTile(
                  title: 'Nova Chamada / Corrida',
                  subtitle: 'Tocar alarme ao receber pedido',
                ...
                _buildAudioTile(
                  title: 'Entrega Concluída / Coleta',
                  subtitle: 'Tocar bip ao finalizar ou ler malote',
                  icon: Icons.flag,
                ...
                const Divider(color: Colors.white12, height: 1, indent: 20, endIndent: 20),
                _buildAudioTile(
                  title: 'Rota / Expediente Finalizado',
                  subtitle: 'Tocar som de comemoração ao concluir todas as entregas do dia',
                  icon: Icons.emoji_events_rounded,
                  iconColor: const Color(0xFFFFD54F),
                  value: _audioService.somRotaCompleta,
                  onChanged: geralAtivo ? _onRotaCompletaChanged : null,
                  onTest: _audioService.tocarRotaCompleta,
                ),
                const Divider(color: Colors.white12, height: 1, indent: 20, endIndent: 20),
                _buildAudioTile(
                  title: 'Alertas e Erros',
                  subtitle: 'Tocar aviso em falhas de rota ou leitura',
  ...
  Widget _buildAudioTile({
    ...
    Color iconColor = const Color(0xFF00B0FF),
    required bool value,
